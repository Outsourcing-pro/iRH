...
<template>
    <div class="page">
        ...
        <medical-actionsheet class="as-medical" 
            ref="filter"
            :currentType="type"
...
<script>
	...
	export default {
		...
		created() {
			this.type = this.pagingOption.params.type = parseInt(this.getRouter.params.type);
			this.id = this.pagingOption.params.custid = this.getRouter.params.id;
		},
		methods: {
            changeType(index){ //打开切换类型弹窗
                this.openAsMedical = !this.openAsMedical;
        	},
