...
<template>
    <scroller-base ref="baseScrollerVue" :data="data">
        <slot></slot>
...
<script>
    export default {
                ...
                paging: {
                    ...
                    hasDataHook: function (res) {
                        ...
                        if (errorcode === app.errok) {
                        	let pageindex = res.data.page;
                            return pageindex < res.data[this.pageOpt.countKey];
                        }
                        return true;
                    }
                },
        ...
        methods: {
            ...
            // 初始化分页'paging'实例
            _initPaging() {
                Object.assign(this.paging, this.pagingOption);
            ...
            pagingLoad() {
                ...
                if (this.paging.isLoading) {
                    ...
                    if (this.paging.page[this.pageIndexKey] === this.initedIndex) this.paging.cancel("操作被用户取消");
                }
