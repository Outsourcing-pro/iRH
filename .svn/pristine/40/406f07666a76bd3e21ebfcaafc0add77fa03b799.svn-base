...
<template>
    ...
    <!-- <div ref='scrollWindow' class="scroller-window" @click="makeFormBlur"> -->
...
<script>
    ...
    // import {winResizeMixin} from 'assets/js/app/mixin.js';
    // import {KeyboardMixin} from './mixin/keyboard-mixin.js';

    export default {
        name: 'scroller-base',
        // mixins: [winResizeMixin, KeyboardMixin],
        props: {
            data: { // 会监控此数据的变化来动态刷新滚动条
                default: null
            },
            options: { // 实例化滚动条的选项, 同'iscroll5'的选项参数
                type: Object
            }
        },
        data() {
            return {
                scroller: null, // 用于保存滚动条实例
                defaultCfg: {
        ...
        methods: {
            ...
            _initScroll() {
                ...
                this.scroller = new JScroll(this.$refs.scrollWindow, opts);
            },
            _winResizeHandler() {
                this.refresh();
            },
