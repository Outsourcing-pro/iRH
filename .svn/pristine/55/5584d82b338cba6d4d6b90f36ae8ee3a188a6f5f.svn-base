	...
	<div class="page">
		...
		<div class="container">
            ...
            <div class="tag-item">
                ...
                <div class="lables">
                    <span @click="toMedicalRecords(0)">全部</span>
                    <span @click="toMedicalRecords(1)">住院记录</span>
                    <span @click="toMedicalRecords(2)">门诊记录</span>
                </div>
            </div>
            <div class="separate"></div>
		</div>
...
export default {
    ...
    methods: {
        ...
        toMedicalRecords(type) {
            this.$router.push({path: `/medicalRecords/${type}/${this.cid}`})
        }
    }
};
</script>
